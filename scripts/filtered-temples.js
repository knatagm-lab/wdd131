...
const temples = [
  ...
  },
  {
    ...
    area: 25349,
    imageUrl:"https://churchofjesuschristtemples.org/assets/img/temples/barranquilla-colombia-temple/barranquilla-colombia-temple-1846.jpg"
  },
  {
...
function displayTemples(temples) {
    ...
    temples.forEach((temple) => {
        ...
        location.innerHTML = `<strong>Dedicated:</strong> ${temple.dedicated}`;
